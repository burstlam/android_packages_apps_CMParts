...
public class UIActivity extends PreferenceActivity implements OnPreferenceChangeListener {
    ...
    private static final String BOOTANIMATION_PATH_PREF = "pref_bootanimation_path";
    ...
    private Preference mBootanimationPath;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mBootanimationPath = (Preference) prefSet.findPreference(BOOTANIMATION_PATH_PREF);
        String bPathPref = Settings.System.getString(getContentResolver(),
                Settings.System.BOOTANIMATION_PATH);
        if (bPathPref == null || bPathPref == "") {
            bPathPref = "Default";
            Settings.System.putString(getContentResolver(),
                    Settings.System.BOOTANIMATION_PATH,
                    bPathPref);
                    mBootReset.setEnabled(false);
        } else {
            if ( bPathPref == "Default") {
                mBootReset.setEnabled(false);
            }
        }
        mBootPref.setSummary(bPathPref);
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (preference == mStatusBarScreen) {
            ...
            return true;
                ...
                mBootPref.setSummary(Settings.System.getString(getContentResolver(),
                        Settings.System.BOOTANIMATION_PATH));
            return true;
        }
        return false;
        ...
        switch (requestCode) {
            case REQUEST_CODE_PICK_FILE:
                if (resultCode == RESULT_OK && data != null) {
                    ...
                    mBootPref.setSummary(fileUri.getLastPathSegment());
                    Settings.System.putString(getContentResolver(),
                            Settings.System.BOOTANIMATION_PATH,
                            fileUri.toString());
                    if (fileUri != null) {
